...
public class BlockAgenda implements Serializable {
	...
	public ArrayList<AgendaQueryBuilder> queries = new ArrayList<AgendaQueryBuilder>();
...
/** Block Agendas **/
	...
	public static ArrayList<String> getBlockAgendaQueryTitles(int agendaPos, Context context) {
		...
		for (AgendaQueryBuilder query : blockAgenda.queries)
...
/** Block Agenda Query **/
	...
	public static AgendaQueryBuilder getAgendaBlockEntry(int agendaPos, int blockPos, Context context) {
		BlockAgenda blockAgenda = getBlockAgenda(agendaPos, context);
		if(blockPos >= 0 && blockPos < blockAgenda.queries.size())
			return blockAgenda.queries.get(blockPos);
		else
			return new AgendaQueryBuilder("");
	}
	...
	public static void writeAgendaBlockEntry(AgendaQueryBuilder query, int agendaPos, int blockPos, Context context) {
		try {
			ArrayList<BlockAgenda> agendas = readAgendas(context);
